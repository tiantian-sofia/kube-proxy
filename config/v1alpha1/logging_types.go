...
// The logging-related types in this file are wire-compatible copies of the
// types in k8s.io/component-base/logs/api/v1 (LoggingConfiguration and its
// transitively referenced types). They are duplicated here so that importing
// this API package does not pull in the component-base logging stack (CLI
// flags, feature gates, metrics, klog, ...). The field names, json tags and
// (un)marshalling behavior must be kept in sync with the originals.
